  ...
  return (
    <div className="w-full h-full bg-back_login flex justify-center items-center">
        <div className="flex w-11/12 h-5/6 rounded-[37px] bg-blue_login flex m-auto p-3">
            ...
            <Image src="/login-bg.jpeg" alt="PTF" width={700} height={90} className="hidden lg:block m-auto rounded-[90px]"/>
            ...
            <form className="bg-white w-full lg:w-5/12 h-full rounded-[37px] p-4">
              <div className="flex flex-col justify-between">
                <div>
                  ...
                  <h1 className="text-center text-5xl p-8">Bienvenue !</h1>
                  <h3 className="text-center text-sm">Merci d'entrer vos informations</h3>
                </div>

                <div>
                  <Input type="email" placeholder="Email" className="w-10/12"></Input>
                  <Input type="password" placeholder="Mot de passe" className="w-10/12"></Input>
